...
flags.DEFINE_string('vis_logdir', './vis_logdir', 'Where to write the event logs.')             # None

flags.DEFINE_string('checkpoint_dir', './Pascal_voc_seg/train_logdir/model.ckpt-5493', 'Directory of model checkpoints.')
